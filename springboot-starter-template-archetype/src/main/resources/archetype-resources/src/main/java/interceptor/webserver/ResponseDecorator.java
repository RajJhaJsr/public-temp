...
//        }
    ...
    private String addTimestampToJson(String originalJson) {
        if (originalJson.trim().startsWith("{") && originalJson.trim().endsWith("}")) {
            ...
            String traceInfo = String.format("${symbol_escape}"trace_id${symbol_escape}":${symbol_escape}"%s${symbol_escape}",${symbol_escape}"response_time${symbol_escape}":${symbol_escape}"%sms${symbol_escape}",${symbol_escape}"server_timestamp${symbol_escape}":${symbol_escape}"%s${symbol_escape}"", 
                    traceId, 
            ...
            String timestamp = LocalDateTime.now().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME);
            return String.format("{${symbol_escape}"data${symbol_escape}":%s,${symbol_escape}"trace_id${symbol_escape}":${symbol_escape}"%s${symbol_escape}",${symbol_escape}"response_time${symbol_escape}":${symbol_escape}"%sms${symbol_escape}",${symbol_escape}"server_timestamp${symbol_escape}":${symbol_escape}"%s${symbol_escape}"}", 
